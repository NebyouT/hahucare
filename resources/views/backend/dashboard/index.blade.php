                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card dashboard-card border-0 hover-shadow transition-all position-relative mb-0">
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-start gap-3">
                                        <div>
                                            <h6 class="text-heading text-uppercase">{{ __('dashboard.total_lab_services') }}
                                            </h6>
                                            <h2 class="mb-0 fw-bold">{{ $data['total_lab_services'] ?? 0 }}</h2>
                                        </div>
                                        <div class="card-icon bg-primary-subtle p-3 rounded-3">
                                            <img src="{{ asset('img/dashboard/services.png') }}" alt="Lab Services"
                                                class="img-fluid avatar-50 object-contain">
                                        </div>
                                    </div>
                                </div>
