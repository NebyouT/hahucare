...
@section('title') {{ __('Create Lab Result') }} @endsection
...
<div class="container-fluid px-4">
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">{{ __('Create Lab Result') }}</h5>
            <a href="{{ route('backend.lab-results.index') }}" class="btn btn-secondary btn-sm">
                <i class="ph ph-arrow-left"></i> {{ __('Back') }}
            </a>
        </div>
        <div class="card-body">
                    <form method="POST" action="{{ route('backend.lab-results.store') }}" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">{{ __('Result Code') }}<span class="text-danger">*</span></label>
                                <input type="text" name="result_code" class="form-control" value="{{ old('result_code') }}" required>
                                @error('result_code')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="patient_id" class="form-control" value="{{ old('patient_id') }}" required>
                                @error('patient_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="doctor_id" class="form-control" value="{{ old('doctor_id') }}">
                                @error('doctor_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="sample_id" class="form-control" value="{{ old('sample_id') }}">
                                @error('sample_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="result_value" class="form-control" value="{{ old('result_value') }}">
                                @error('result_value')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
