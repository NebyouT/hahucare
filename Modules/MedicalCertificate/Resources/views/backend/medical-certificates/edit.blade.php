...
@section('title')
    {{ __('medicalcertificate.edit_medical_certificate') }}
@endsection
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h4 class="m-b-10">{{ __('medicalcertificate.edit_medical_certificate') }}</h4>
                </div>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">{{ __('medicalcertificate.edit_medical_certificate') }}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('medicalcertificate.edit_medical_certificate') }}</h5>
                </div>
                <div class="card-body">
